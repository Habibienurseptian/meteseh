...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        {{-- Mengubah ukuran font di mobile --}}
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-6 sm:mb-8 border-b-2 border-indigo-500 pb-4">
            Tambah Booking Baru
        </h2>

        <form action="{{ route('staf.bookings.store') }}" method="POST" class="space-y-6 sm:space-y-8">
            @csrf

            {{-- Card for Informasi Booking --}}
            <div class="bg-gray-50 rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4">Informasi Booking</h3>
                {{-- Menambahkan lg:grid-cols-3 untuk layar desktop --}}
            ...
            <div class="bg-gray-50 rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4">Informasi Rombongan</h3>
            ...
            <div class="bg-gray-50 rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4">Kontak Person & Jadwal</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
            ...
            {{-- Card for Catatan --}}
            <div class="bg-gray-50 rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4">Catatan Tambahan</h3>
                <div>
