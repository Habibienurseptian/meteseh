...
<div class="container mx-auto px-4 py-6">
    {{-- Mengatur padding agar lebih kecil di mobile, lalu membesar di tablet dan desktop --}}
    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 sm:gap-x-8 gap-y-4 sm:gap-y-6 mb-8 sm:mb-10">
            <div class="col-span-full">
                {{-- Mengubah ukuran font H3 agar lebih kecil di mobile --}}
            ...
            <div class="flex flex-col">
                ...
                <p class="text-lg font-semibold text-gray-900">
                    @if ($booking->maktab)
                        <a href="{{ route('staf.maktab.show', ['maktab' => $booking->maktab->id]) }}"
        ...
        <div class="mt-8 sm:mt-10 flex flex-col-reverse sm:flex-row sm:justify-end gap-3 sm:gap-4">
            ...
            <a href="{{ route('staf.bookings.edit', ['booking' => $booking->id]) }}" class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-indigo-600 text-white rounded-lg shadow-md hover:bg-indigo-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
